...
use crate::cmds::dart::flutter_cmd::{
    has_json_reporter, run_with_toml_filter, summarize_dart_analyze, summarize_flutter_test,
};
...
pub fn run(args: &[String], verbose: u8) -> Result<i32> {
    ...
    if let Some(result) = run_with_toml_filter("dart", args, verbose) {
        return result;
    }
